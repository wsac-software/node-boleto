...
exports.mod11Sicoob = function (num, agencia, codigoCliente) {
  var sequencia = exports.addTrailingZeros(agencia, 4) + exports.addTrailingZeros(codigoCliente, 10) + exports.addTrailingZeros(num, 7)
  var count = 0
  var calculoDv = 0

  for (var k = 0; k < sequencia.length; k++) {
    count++
    var constante
    ...
    calculoDv += parseInt(sequencia[k]) * constante
  }
